...
@external(javascript, "./dom/file_ffi.mjs", "new_")
...
@external(javascript, "./dom/file_ffi.mjs", "text")
pub fn text(file: File) -> Promise(String)

@external(javascript, "./dom/file_ffi.mjs", "bytes")
pub fn bytes(file: File) -> Promise(BitArray)

@external(javascript, "./dom/file_ffi.mjs", "name")
pub fn name(file: File) -> String

@external(javascript, "./dom/file_ffi.mjs", "mime")
pub fn mime(file: File) -> String

@external(javascript, "./dom/file_ffi.mjs", "size")
pub fn size(file: File) -> Int

@external(javascript, "./dom/file_ffi.mjs", "createObjectURL")
