...
import gbr/js/file_system.{type DirectoryHandle}
...
@external(javascript, "./dom/storage_ffi.mjs", "getStorage")
pub fn get() -> Result(StorageManager, Nil)

@external(javascript, "./dom/storage_ffi.mjs", "estimate")
...
@external(javascript, "./dom/storage_ffi.mjs", "getDirectory")
pub fn get_directory(
  storage: StorageManager,
) -> Promise(Result(DirectoryHandle, String))

@external(javascript, "./dom/storage_ffi.mjs", "persist")
pub fn persist(storage: StorageManager) -> Promise(Result(Bool, String))

@external(javascript, "./dom/storage_ffi.mjs", "persisted")
...
@external(javascript, "./dom/storage_ffi.mjs", "setItem")
pub fn set_item(
  storage: Storage,
  key: String,
  value: String,
...
@external(javascript, "./dom/storage_ffi.mjs", "removeItem")
pub fn remove_item(storage: Storage, key: String) -> Result(Nil, String)

/// Clears the storage of all items.
@external(javascript, "./dom/storage_ffi.mjs", "clear")
